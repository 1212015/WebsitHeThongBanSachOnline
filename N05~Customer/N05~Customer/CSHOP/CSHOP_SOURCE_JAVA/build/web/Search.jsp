...
%>
<!DOCTYPE html>
<html lang="en" ng-app="SearchApp" ng-controller="SearchCtrl">
                                                            ...
                                                            <div class="action">
                                                                <ul class="list-unstyled">
                                                                    ...
                                                                    <li class="lnk wishlist">
                                                                        <a class="add-to-cart" ng-hide="<%=!isauth%>" href="themvaogiasach?id={{p.idProducts}}&iduser=<%=iduser%>" title="Giá sách">
    ...
    <jsp:include page="_footer.jsp"></jsp:include>
        ...
        <script>
            ...
            app.controller('SearchCtrl', ['$scope', '$location', '$window', '$http', function ($scope, $location, $window, $http) {
                    
                    $http({
                            method: 'GET',
                            url: "SearchProductNgController" 
