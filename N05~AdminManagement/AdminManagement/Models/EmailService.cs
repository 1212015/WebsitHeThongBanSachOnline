...
namespace MvcSendMail.Models
{
    ...
    public class EmailService
    {
        ...
        /// </summary>
        /// <param name="smtpUserName">Tên đăng nhập email gửi thư: vd:nguyentiendung</param>
        /// <param name="smtpPassword">Mật khẩu của email gửi thư</param>
        /// <param name="smtpHost">Host email. vd smtp.gmail.com</param>
        /// <param name="smtpPort">Port vd: 587</param>
        /// <param name="toEmail">Email nhận vd: khanhson247@gmail.com</param>
